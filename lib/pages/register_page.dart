    ...
    return Scaffold(
      body: Container(
        ...
        child: SafeArea(
          child: Column(
            children: [
              // 1. Progress Bar di bagian paling atas
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 24.0, vertical: 20),
                child: Row(
                  children: [
                    // Garis 1 (Aktif/Sedang diisi) - bisa dikasih warna beda kalau mau
                    Expanded(
                      child: Container(
                        height: 6,
                        decoration: BoxDecoration(
                          color: Colors.grey[350], // Abu-abu
              ...
              Padding(
                ...
                child: SizedBox(
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                    // Validasi sederhana (opsional: pastikan nama tidak kosong)
              ...
              // Tampilkan pesan error kecil (Snackbar) jika nama kosong
